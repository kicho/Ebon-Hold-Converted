...
// will only support WoW, WoW:TBC and WoW:WotLK 3.2.2a client build 10505... (3.2.2 , 3.2.0, 3.2.0a, 3.1.3)

#define EXPECTED_MANGOS_CLIENT_BUILD        {10505, 10482, 10192, 10314, 9947, 0}
